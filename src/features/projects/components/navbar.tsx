                    ...
                    <BreadcrumbList className="gap-0!">
                        <BreadcrumbItem>
                            <BreadcrumbLink className="flex items-center gap-1.5 group/logo" asChild>
                                <Button variant={"ghost"} className="w-fit! p-1.5! h-7!" asChild>
                                    <Link href="/">
                                        <Image src="/logo.svg" alt="Prometheus" width={20} height={20} />
                                        <span className={cn("text-sm font-medium", font.className)}>Prometheus</span>
                                    </Link>
                                </Button>
                            </BreadcrumbLink>
                        </BreadcrumbItem>
                        ...
                        <BreadcrumbItem>
                            {isRenaming ? (
                                ...
                                <BreadcrumbPage onClick={handleStartRename} className="text-sm cursor-pointer hover:text-primary font-medium max-w-409 truncate">
